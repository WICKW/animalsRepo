...
public interface UserRepository {
    ...
    /*
    *     final String INSERT = "INSERT INTO users (Name, Surname, DateOfRegistration, " +
            "UserTypeId, UserRoleId, Phone, AddressId, Email, SocialLogin, " +
            "Password, OrganizationName, OrganizationInfo, IsActive) " +
            "VALUES (#{name}, #{surname}, #{registrationDate}, #{userType.id}, " +
            "#{userRole, typeHandler=com.animals.app.domain.UserRole}, #{phone}, #{address.id}, #{email}, #{socialLogin}, " +
            "#{password}, #{organizationName}, #{organizationInfo}, #{isActive})";
    * */
